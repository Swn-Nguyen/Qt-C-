...
namespace {
struct qt_meta_tag_ZN7watcherE_t {};
} // unnamed namespace

template <> constexpr inline auto watcher::qt_create_metaobjectdata<qt_meta_tag_ZN7watcherE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<watcher, qt_meta_tag_ZN7watcherE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject watcher::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7watcherE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7watcherE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN7watcherE_t>.metaTypes,
    nullptr
} };
...
void *watcher::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7watcherE_t>.strings))
